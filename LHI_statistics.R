...
# ------------------------------------------------------------
# 13. ACROPORA PALING — NORTH ONLY (SINGLE-SITE MODEL)
# ------------------------------------------------------------

filtered_data <- df_health_specific_count %>% filter(Site == "North")
...
Acro_paling <- emmeans(model_acro_paling, ~ Month, type = "response")
