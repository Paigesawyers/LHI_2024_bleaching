...
(fig_live_coral_cover <-
   ...
   facet_grid(. ~ Site) +
   scale_x_discrete(
     labels = function(x) paste(x, "2024")
   ) +
   scale_y_continuous(
     expand = c(0, 0.01),
     limits = c(0, 1),
...
# ggsave(
#   filename = "fig_live_coral_cover.jpg",
...
# Extract colours from Antique palette
antique_cols <- paletteer_d("rcartocolor::Antique")

antique_cols <- as.character(paletteer_d("rcartocolor::Antique"))

## checking colour codes form palette
show_col(antique_cols)
antique_cols

# Assign selected palette colours to genera
genus_cols <- c(
  "Acropora"    = "#855C75FF",  
  "Isopora"     = "#AF6458FF",  
  "Porites"     = "#526A83FF",  
  "Cladiella"   = "#D9AF6BFF",  
  "Pocillopora" = "#736F4CFF",  
  "Xenia"       = "#625377FF"
)
...
## save figure
# ggsave(
#   filename = "fig_genera_distribution.png",
...
#Save figure
# ggsave(
#   filename = "fig_health_specific.png",
...
## combining site health and nmds figures together

library(patchwork)

fig_health_publication <-
  fig_lhi_nmds / combined_health_plot +
...
# ggsave(
#   "fig_lhi_nmds_combined_health.png",
#   fig_health_publication,
#   width = 8,
#   height = 14,
#   dpi = 300
